...
use crate::slab::Slab;
use locker::mutex::local_tagged::LocalTaggedLock;

type Mutex<T> = locker::mutex::Mutex<LocalTaggedLock, T>;
...
impl AsyncStdWakerSet {
    ...
    pub const fn new() -> AsyncStdWakerSet {
        AsyncStdWakerSet {
            inner: LocalTaggedLock::mutex(Inner {
                entries: Slab::new(),
                notifiable: 0,
            }),
        }
